...
img = cv2.imread("images/oscar_faini.jpg")
img2 = cv2.imread("images/victoria_vela.jpg")
...
# Cargamos el detector de los puntos de referencia en los rostros
...
# Triangulacion de las dos caras
for triangle_index in indexes_triangles:
    #Triangulacion del primer rostro
    ...
    #Reconstruccion del rostro de destino
